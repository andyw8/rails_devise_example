...
class ActiveSupport::TestCase
  sig { params(fixture_name: NilClass, other_fixtures: NilClass).returns(T::Array[Admin]) }
  sig { params(fixture_name: T.any(String, Symbol), other_fixtures: NilClass).returns(Admin) }
  sig { params(fixture_name: T.any(String, Symbol), other_fixtures: T.any(String, Symbol)).returns(T::Array[Admin]) }
  def admins(fixture_name = nil, *other_fixtures); end
